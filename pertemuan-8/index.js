...
const sayGreetings3 = (fullName = "John", age = 30, address = "Manado") =>
...
//Dengan menggunakan ES6 cari index negara indonesia
//clue: findIndex()
let index = countries.findIndex((item) => item === "Indonesia");
console.log(index);
